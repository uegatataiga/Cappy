class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:item).permit(:name, :introduction, :star,:favorites, :genre_id, :video,:rakuten_image, :rakuten_name, :rakuten_url, :rakuten_introduction,:rakuten_code,images: [])
  end
